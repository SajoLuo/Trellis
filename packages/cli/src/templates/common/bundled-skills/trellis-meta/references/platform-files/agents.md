...
| DeepSeek Harness | `.dsh/skills/trellis-agent-*/SKILL.md` (role prompts as skills; dispatched through the default continuable background `subagent` and gated by its settlement notice) |
